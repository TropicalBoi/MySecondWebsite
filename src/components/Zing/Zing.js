        ...
        <div className="ZingScroll">
          <div className="Zing1">
            ...
            <div className="TextZingC">
              ...
              <p className="TextBox">
                ...
                rad. Ones that exceed the normal definition of a video.
              </p>
              <p className="TextBox">
                ...
                moving images. ZING VIDEO is an exhibition platform for all
                those interested in the subject, no matter the practice. We
                welcome those from all fields, whether it be an animator,
                designer, vlogger, and etc.
              </p>
            </div>
          </div>
          <div className="FishTank">
            <img
              src={zingImages.TankTube}
              className="TankTube"
              alt="Fish Tank"
            />
            <img
              src={zingImages.FishGang}
              className="FishGang"
              alt="Fish Tank"
            />
            ...
            <img
              src={zingImages.guppy3}
              className="guppy10-3"
              alt="Fish Tank"
            />
            <img
              src={zingImages.guppy8}
              className="guppy11-8"
              alt="Fish Tank"
            />
            <img
              src={zingImages.guppy1}
              className="guppy12-1"
              alt="Fish Tank"
            />
            <img
              src={zingImages.guppy7}
              className="guppy13-7"
              alt="Fish Tank"
            />
            ...
            <p className="FishTankText1">
              ...
              ecosystem of a fish tank and installed a screen within it.
              Situated on the second-floor dining area of a restaurant.
            </p>
            <img
            ...
            <p className="FishTankText2">
              ...
              and exchange their expertise and practice amongst each other.
              Cheng Night Screening Programme was an event for intimate moving
              image practitioners to inhabit the fish tank and its other
              inhabitants without a time limit, come throw words and ideas into
              the tank.
            </p>
            <img
          ...
          <div className="ZZTV">
            ...
            <p className="ZZTVtext2">
              ...
              Cultural Center to raise their voices through live music,
            ...
            <p className="ZZTVtext3">
              ...
              surveillance cameras for the event by streaming live videos
              through our Facebook page in an attempt to report, ensure safety
              and record one of the significant moments of our time. Along with
              live streaming, we did jam images into the video to expand the
              atmosphere of the event and to express our opinion toward it.
            </p>
