      ...
      <div className="FriendshipContent1">
        ...
        <div className="friendshipText1">
          ...
          <div className="friendshipTextbox">
            ...
            Relying on symbols and metaphors, they function as an often-humorous
            coded language that cannot be understood in a literal sense. This
            video is a commentary about free speech and uses memes as a code to
            convey historic information that may otherwise be prohibited in
            Thailand. The narrative requires a 'decoding' process in order to
            fully make sense, however it can also be viewed as a visual piece
            that stimulates curiosity, provoking the viewer to find out more
            about the symbols that are used within it.
          </div>
        </div>
        <img
        ...
        <div className="friendshipText3">
          The exhibition presented the works of 11 artists and creators who took
          part in the UNESCO workshop on Internet Universality in May 2018. It
          highlights their unique perspectives on issues surrounding the
          Internet ecosystem in Southeast Asia.
        </div>
        <img
