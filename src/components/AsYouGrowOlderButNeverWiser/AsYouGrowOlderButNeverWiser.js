      ...
      <div className="AsYouContent1">
        ...
        <div className="AsYouText1">
          <p className="AsYouTextBox">
            Any excavation of history holds what which is unexpected. To come to
            the realization that what is labeled as history is not so far
          ...
          <p className="AsYouTextBox">
            ...
            that I modified its extension so it can be viewed through a GameBoy.
            The video loops significant images from the same era connecting
            separate contexts of a media that normally projecting imaginary
            worlds of video games replaced with the reality of the time.
          </p>
        </div>
        <img
          src={asYouImages.AsYouPic1}
        ...
        <p className="AsYouText2">
          ...
          young millennial artists based in Bangkok. Sharing the frustrations of
          pursuing a career in the arts in their mid-to-late twenties, each take
          on a common Thai Northeastern slang หลุย (Louie), which means a failed
          attempt, a botch, and a glitch. While the slang is usually said with
          attitude towards a mishap in their daily lives, being a familiar line
          amongst the peers of the generation, what is considered Louie has
          multitudes of meanings, particular to each situation yet is
          symptomatic of the circumstances that they inhabit as a whole.
        </p>
        <p className="AsYouText3">
          Putting together these multiplicities of Louie therefore takes on not
          only the micro-narratives embodied in each artist, but expands to
          bigger socio-political issues which structures those failures. This
          exhibition grasps at the unique youthful spirit and attitudes of these
          artists when responding to failure as a generation. It is
