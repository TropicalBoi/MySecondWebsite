    ...
    <div className="IWillContent">
      ...
      <div className="IWillContent1">
        ...
        <p className="IWillText1">
          ...
          collaboration with Wasawat Somno, a programmer. Together we wanted to
          explore what forms a video file could inhabit. Through this project we
          manifested a digital matter (in this case, a video file) into a
          physical object without altering its original code. Thus, everyone who
          interacted with the piece was able to transform the physical object
          back to the original video file. This exploration of digital/physical
          alteration still continues in my practice.
        </p>
        ...
        <p className="IWillAW1Text1">
          ...
          that I have saved in it in from the past 5 years. When I brought it to
          a recovery lab they were able to bring all my files back. However, it
          would be on a new hard disk drive and the original one would be
          rendered a carcass.
        </p>
        <p className="IWillAW1Text2">
          They returned my files back. I held a brand-new external HDD in my
          right hand and the carcass of 5 years’ worth of memories in my left. I
          looked at it and felt mournful. At this point I started to become
          curious if other people have this feeling for their dead devices. So,
          I dissected my old hard drive and presented it as an anatomical study.
        </p>
        ...
        <p className="IWillAW2Text1">
          ...
          information, theories, methods and similar approaches that people have
          done before in history. I printed it all on thermal papers that can
          fade away in a short amount of time to visualize loss that is caused
          by time.
        </p>
        <p className="IWillAW2Text2">
          ...
          days. I was so amazed by its perfect time constraints that it became a
          condition of its warranty. So, I decided to use this same condition to
          maintain the information of this project.
        </p>
        <img
        ...
        <p className="IWillMockupsText">
          (Due to the art center’s condition controlled space, it turned out all
          the information on any papers didn’t fade away at all. So on this page
          I demonstrated a result according to my initial intention.)
        </p>
        <GlassMagnifier
        ...
        <p className="IWillAW3Text1">
          ...
          Notepad. It gains 14 million of texts for just one file. I saved it as
          a plain text file and then I changed its extension from .txt to .mp4
          and I got the original video file back. So, I realize that as long as
          I don’t edit or touch any of those texts it can be transformed back to
          its original file. This became my main presumption and method for this
          project.
        </p>
        ...
        <p className="IWillAW4Text1">
          ...
          possible way to make it shorter without damaging its original file and
          tried different materials that can last longer than papers.
        </p>
        <img
        ...
        <p className="IWillAW5Text1">
          ...
          was used widely to encode and decode files and transformed it into QR
          codes so we got 132 pieces of QR codes that can transform back to the
          original video file by scanning all of it starting from the first one.
          Using the application that Wasawat made, it will help to collect and
          join each QR code together correctly and transform it back to its
          original file.
        </p>
        ...
        <p className="IWillAW6Text1">
          ...
          historically can last for more than 3000 years until now and to refer
          to the one of the traditional materials and methods that have been
          used to make artistic sculptures until these days.
        </p>
        ...
        <div className="IWillAW7Text1">
          <p>
            ...
            this question. Happening on many platforms including but not limited
            to, physical rotating exhibition, online browser exhibition, virtual
            worlds, and publication. The Centennial is a manifestation of
            grandma’s spirit across many mediums, with many timelines, all at
            once.
          </p>
          <p>
            “Speedy Grandma Centennial” will happen at our new space, the
            building on Charoenkrung 24. This exhibition is to return and
            revisit the same ideas that Granny first opened with in 2012, where
            we want to support young and emerging artists. Bridging them with
            those of other generations, conversing across time with over 33
            artists.
          </p>
        </div>
        <p className="IWillAW7Text2">
          ...
          what couldn’t be exhibited last time. Thus, the piece consists of the
          following:
        </p>
        ...
        >
          <p>
            ...
            wasn’t actualized due to several limitations. This body of work aims
            to demonstrate the possibility and capacity of the same piece to
            shapeshift in accordance to different contexts and spaces.
          </p>
        </a>
